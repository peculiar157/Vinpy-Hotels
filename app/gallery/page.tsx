  ...
  return (
    <div>
      <section className="bg-purple-700 pt-20 pb-16 px-6 text-center">
        <p className="font-inter text-xs font-semibold text-gold-400 uppercase tracking-widest mb-4">
          Visual Tour
        </p>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-auto">
          {placeholders.map((item) => (
            ...
            >
              <div
                className={item.height + " bg-gradient-to-br " + item.gradient + " flex items-center justify-center relative"}
              >
        ...
        <div className="mt-10 text-center">
          <p className="font-inter text-sm text-gray-500">
            Follow us on{" "}
            <span className="text-purple-500 font-medium">@vinpyhotels on Instagram</span>
